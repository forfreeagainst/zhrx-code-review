...
describe('Validate JS configs', () => {
  it('Validate eslint-config-zhrx', async () => {
  ...
  it('Validate eslint-config-zhrx/es5', async () => {
  ...
  it('Validate eslint-config-zhrx/vue', async () => {
  ...
  it('Validate eslint-config-zhrx/essential', async () => {
  ...
  it('Validate eslint-config-zhrx/essential/es5', async () => {
  ...
  it('Validate eslint-config-zhrx/essential/react', async () => {
  ...
  it('Validate eslint-config-zhrx/essential/vue', async () => {
  ...
  it('Validate eslint-config-zhrx/node', async () => {

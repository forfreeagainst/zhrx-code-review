...
describe('Validate TS configs', () => {
  it('Validate eslint-config-zhrx/typescript', async () => {
  ...
  it('Validate eslint-config-zhrx/typescript/vue', async () => {
  ...
  it('Validate eslint-config-zhrx/essential/typescript', async () => {
  ...
  it('Validate eslint-config-zhrx/essential/typescript/react', async () => {
  ...
  it('Validate eslint-config-zhrx/essential/typescript/vue', async () => {
  ...
  it('Validate eslint-config-zhrx/typescript/node', async () => {
